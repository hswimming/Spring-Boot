...
public class SpringSecurityConfig {
	...
	private static final String[] WHITE_LIST = {"/security/all", "/auth/**", "/v3/**", "swagger-ui/**", "/error"}; // 로그인 하지 않아도 들어갈 수 있음
	private static final String[] USER_LIST = {"/security/user", "/webboard/**", "/replies/**", "/api/board/**"}; // webboard, replies로 시작하는 경로 전부 (로그인 해야 가능)
